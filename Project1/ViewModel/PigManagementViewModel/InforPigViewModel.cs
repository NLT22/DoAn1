...
using System.Net;
using static Project1.ViewModel.BaseViewModel;
...
{
    public class InforPigViewModel : BaseViewModel
    {
        ...
        public PigPen PenManagementItem
        {
            ...
            set
            {
                ...
                Pig_List = new ObservableCollection<Pig>(DataProvider.Ins.DB.Pigs.Where(p => p.pen_id == _PenManagementItem.pen_id));
                OnPropertyChanged();
            }
        }
        ...
        public InforPigViewModel()
        {
            ...
            PenManagementItem = DataProvider.Ins.DB.PigPens.FirstOrDefault(p => p.pen_id == PigSelectedItem.pen_id);
            ...
            NewVaccineCommand = new RelayCommand<object>(
                ...
                (p) => { NewVaccine(); });
            SaveCommand = new RelayCommand<Window>((p) => { return SaveCondition(); }, (p) => { SaveNV(); });
        ...
        public bool SaveCondition()
        {
            if (IsGeneralChecked)
            {
                return PigType_TB != null && Gender_TB != null && Health_TB != null && Birth_TB != null && Import_TB != null && PenSelectedItem != null;
            }
